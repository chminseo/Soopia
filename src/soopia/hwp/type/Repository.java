...
import soopia.hwp.codec.StyleRecordDecoder;
...
public class Repository {
	...
	private void installDecoder(){
		...
		decoderMap.put(StyleRecord.class, new StyleRecordDecoder());
	}
	public void installDefault(){
		...
		recordStructMap.put(Constant.HWPTAG_BEGIN + (++idx), StyleRecord.class);
